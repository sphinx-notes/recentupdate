...
project = 'sphinxnotes-recentupdate'
author = 'Shengyu Zhang'
copyright = "2025, " + author

# The full version, including alpha/beta/rc tags
version = release = '1.0a2'
...
html_baseurl = 'https://sphinx.silverrainz.me/recentupdate'
...
extlinks = {
    'issue': ('https://github.com/sphinx-notes/recentupdate/issues/%s', '💬%s'),
    'pull': ('https://github.com/sphinx-notes/recentupdate/pull/%s', '🚀%s'),
    'tag': ('https://github.com/sphinx-notes/recentupdate/releases/tag/%s', '🏷️%s'),
}
